...
class AnimeSongs extends StatefulWidget {
  final int index;
  final musicData;
  const AnimeSongs({Key? key, this.musicData, required this.index})
      : super(key: key);

  @override
  State<AnimeSongs> createState() => _AnimeSongsState();
}

class _AnimeSongsState extends State<AnimeSongs> {
  bool repeat = false;
  bool playing = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(
            color: Color.fromARGB(255, 238, 131, 131),
          ),
          SafeArea(
                                  ...
                                  ListView(
                                    ...
                                    children: [
                                      SlimyCard(
                                        ...
                                        slimeEnabled: true,
                                        color:
                                            Color.fromARGB(255, 238, 131, 131)
                                                .withOpacity(0.30),
