...
class NightSongs extends StatefulWidget {
  final int index;
  final musicData;
  const NightSongs({Key? key, this.musicData, required this.index})
      : super(key: key);

  @override
  State<NightSongs> createState() => _NightSongsState();
}

class _NightSongsState extends State<NightSongs> {
  bool repeat = false;
  bool playing = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(
            color: Color.fromARGB(255, 6, 0, 44).withOpacity(0.9),
          ),
          SafeArea(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color.fromARGB(255, 6, 0, 44).withOpacity(0),
                          Color.fromARGB(255, 46, 184, 226).withOpacity(0),
