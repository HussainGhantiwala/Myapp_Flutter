...
class FavSongs extends StatefulWidget {
  final int index;
  final musicData;
  const FavSongs({Key? key, this.musicData, required this.index})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(
            color: Color.fromARGB(255, 10, 0, 101).withOpacity(0.9),
          ),
          SafeArea(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color.fromARGB(255, 22, 210, 231).withOpacity(0),
                                  ...
                                  ListView(
                                    ...
                                    children: [
                                      SlimyCard(
                                        ...
                                        topCardHeight: 200,
                                        slimeEnabled: true,
                                        color: Color.fromARGB(255, 63, 142, 222)
                                            .withOpacity(0.30),
