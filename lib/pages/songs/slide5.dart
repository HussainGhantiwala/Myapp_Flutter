...
class AnimeSongsTwo extends StatefulWidget {
  final int index;
  final musicData;
  const AnimeSongsTwo({Key? key, this.musicData, required this.index})
      : super(key: key);

  @override
  State<AnimeSongsTwo> createState() => _AnimeSongsTwoState();
}

class _AnimeSongsTwoState extends State<AnimeSongsTwo> {
  bool repeat = false;
  bool playing = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(color: Color.fromARGB(255, 143, 40, 31)),
          SafeArea(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          ...
                          Color.fromARGB(255, 92, 12, 12).withOpacity(1)
                        ],
                      ),
                    ),
                    child: Column(
                                  ...
                                  ListView(
                                    ...
                                    children: [
                                      SlimyCard(
                                        ...
                                        topCardHeight: 200,
                                        slimeEnabled: true,
                                        color: Color.fromARGB(255, 203, 56, 43)
                                            .withOpacity(0.30),
