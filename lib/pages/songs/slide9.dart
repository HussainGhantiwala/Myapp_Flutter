...
class NightSongsTwo extends StatefulWidget {
  final int index;
  final musicData;
  const NightSongsTwo({Key? key, this.musicData, required this.index})
      : super(key: key);

  @override
  State<NightSongsTwo> createState() => _NightSongsTwoState();
}

class _NightSongsTwoState extends State<NightSongsTwo> {
  bool repeat = false;
  bool playing = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(
            color: Color.fromARGB(255, 12, 47, 117),
          ),
          SafeArea(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color.fromARGB(255, 12, 47, 117).withOpacity(0),
                          Color.fromARGB(255, 136, 162, 210).withOpacity(0),
                                  ...
                                  ListView(
                                    ...
                                    children: [
                                      SlimyCard(
                                        ...
                                        topCardHeight: 200,
                                        slimeEnabled: true,
                                        color: Color.fromARGB(255, 6, 0, 44)
                                            .withOpacity(0.30),
